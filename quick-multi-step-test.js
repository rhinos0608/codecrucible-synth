...
const testCommand = 'node dist/index.js "Break down this task into 3 clear steps: Analyze the package.json file, identify the main dependencies, and suggest one improvement. For each step, provide specific actions and expected outcomes."';
...
child.on('close', (code) => {
    ...
    const successCount = [hasSteps, hasImplementation, hasStructure, hasSpecifics].filter(Boolean).length;
