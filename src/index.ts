    ...
    try {
      ...
      if (options.fast || options.skipInit) {
        ...
        const cli = new CodeCrucibleCLI({
          modelClient: null as any, // Will be unused in fast mode
          voiceSystem: null as any, // Will be unused in fast mode
          mcpManager: null as any,  // Will be unused in fast mode
          config: null as any       // Will be unused in fast mode
        });
