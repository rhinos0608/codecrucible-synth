...
console.log(chalk.gray('This test will thoroughly exercise the system\'s file handling capabilities...\n'));
...
testProcess.on('close', (code) => {
  if (code === 0) {
    ...
    console.log(chalk.gray('Check the detailed report above for comprehensive analysis and recommendations.'));
  } else {
