...
export const sessionFileAttachments = pgTable(
...
export const voiceUsageStats = pgTable(
  'voice_usage_stats',
  {
    id: serial('id').primaryKey(),
    userId: varchar('user_id')
...
export const dailyUsageMetrics = pgTable(
  'daily_usage_metrics',
  {
    id: serial('id').primaryKey(),
    userId: varchar('user_id')
  ...
  table => [index('daily_metrics_user_date_idx').on(table.userId, table.date)]
);
...
export const voicePreferences = pgTable(
  ...
  table => [index('voice_prefs_user_pattern_idx').on(table.userId, table.promptPattern)]
);
...
export const usageLimits = pgTable(
  ...
  table => [index('usage_limits_user_date_idx').on(table.userId, table.date)]
);
