...
export function VFSPAnalyticsDashboard() {
  ...
  const mockAnalytics: VFSPAnalytics = {
    volatilityIndex: 42,
    forecastModel: {
    ...
    symbolicPatterns: [
      ...
      {
        pattern: 'Analyzer + Systems Architect',
        significance: 79,
        frequency: 18,
        impact: 'high',
        description: 'Optimal for complex system design'
      },
      {
        pattern: 'Developer + UI/UX Engineer',
        significance: 72,
        frequency: 31,
        impact: 'medium',
        description: 'Strong for full-stack feature development'
      }
    ],
    evolutionTracking: [
      {
        voiceCombination: 'Explorer + Security Engineer',
        effectivenessProgression: [65, 72, 78, 85, 88],
        usageProgression: [5, 12, 18, 22, 24],
        timepoints: ['Week 1', 'Week 2', 'Week 3', 'Week 4', 'Week 5'],
        maturityLevel: 'optimized'
      },
      {
        voiceCombination: 'Analyzer + Performance Engineer',
        effectivenessProgression: [45, 58, 68, 74, 79],
        usageProgression: [2, 8, 14, 16, 18],
        timepoints: ['Week 1', 'Week 2', 'Week 3', 'Week 4', 'Week 5'],
    ...
    insights: [
      ...
      {
        id: '2',
        title: 'Voice Combination Mastery',
        description: 'Explorer + Security Engineer combination shows 88% effectiveness',
        priority: 'medium',
        category: 'efficiency',
        actionRequired: 'Apply this combination to security-related projects'
      }
    ],
    recommendations: [
      {
