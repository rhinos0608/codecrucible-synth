...
const BUILD_CONFIG = {
  ...
  pkgConfig: {
    scripts: 'dist/**/*.js',
    assets: ['config/**/*', 'node_modules/better-sqlite3/build/**/*'],
    nodeVersion: '18',
  },
};
...
async function createReleaseInfo() {
  ...
  const releaseInfo = {
    ...
    installation: {
      ...
      binary: {
        linux:
          'curl -LO https://github.com/rhinos0608/codecrucibe-synth/releases/latest/download/crucible-linux && chmod +x crucible-linux',
        macos:
          'curl -LO https://github.com/rhinos0608/codecrucibe-synth/releases/latest/download/crucible-macos && chmod +x crucible-macos',
        windows:
          'Invoke-WebRequest -Uri "https://github.com/rhinos0608/codecrucibe-synth/releases/latest/download/crucible-win.exe" -OutFile "crucible.exe"',
      },
    },
    features: [
